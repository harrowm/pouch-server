A pouch-server to unencrypt the data in the couchdb database and show it.
This (obviously) has access to the private key that the pouch-form does not have.
<br>
Uses react-router which is so super easy!
<hr>
